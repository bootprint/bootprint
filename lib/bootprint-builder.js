...
function prepareConfig(options) {
    ...
    if (copy.partials || copy.template || copy.helpers || copy.preprocessor) {
        ...
        copy.handlebars = {
            partials: copy.partials || (copy.handlebars && copy.handlebars.partials),
            helpers: copy.helpers || (copy.handlebars && copy.handlebars.helpers),
            template: copy.template || (copy.handlebars && copy.handlebars.template),
            preprocessor: copy.preprocessor || (copy.handlebars && copy.handlebars.preprocessor)
        }
