...
function overrideOptions(options, parentOptions) {
    ...
    coerceToArray(copy, "partials");
    if (copy.less) {
        coerceToArray(copy.less, "main");
        coerceToArray(copy.less, "paths");
    }
    if (_.isString(copy.helpers)) {
        copy.helpers = require(copy.helpers);
    }
 ...
 * @param propertyName {string} the name of the object`s property to replace
 */
